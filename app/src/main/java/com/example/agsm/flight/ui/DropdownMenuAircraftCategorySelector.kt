...
@Composable
fun DropdownMenuAircraftCategorySelector(
    selected: AircraftCategory,
    onSelect: (AircraftCategory) -> Unit
) {
    ...
    Box(
        ...
        Row(
            ...
            if (!expanded) {
                Image(
                    ...
                    contentDescription = "aircraft category selection dropdown menu",
        ...
        DropdownMenu(
            ...
            AircraftCategory.entries.forEach { category ->
                DropdownMenuItem(
