...
@Composable
fun CreateFlightDialog(
    onConfirm: (aircraftModel: String, aircraftCategory: AircraftCategory, airline: String, registrationNumber: String, flightNumber: String) -> Unit,
    onDismiss: () -> Unit,
    errorMessage: String? = null
) {
    var aircraftModel by remember { mutableStateOf("") }
    var aircraftCategory by remember { mutableStateOf(AircraftCategory.F) }
    ...
    Column(
        ...
        Row(
            ...
            DropdownMenuAircraftCategorySelector(aircraftCategory) {
                aircraftCategory = it
            }
        }
            ...
            Button(
                ...
                Row(
                    ...
                    Image(
                        ...
                        contentDescription = "create flight",
